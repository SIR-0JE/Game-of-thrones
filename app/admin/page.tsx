                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-4">
                    ...
                    {Object.entries(HOUSE_CONFIG).map(([key, config]) => (
                      ...
                      >
                        ...
                        <div className="text-xs lg:text-sm font-semibold opacity-90 truncate">{config.name}</div>
                      </div>
                    ))}
                  </div>
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-white/20">
                      ...
                      <div className="flex flex-col lg:flex-row items-center gap-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 flex-1">
                          {chartData?.map((item) => (
                            <div key={item.house} className="flex items-center gap-3 p-2 rounded-lg bg-gray-50">
                              <div
