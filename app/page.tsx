      ...
      <div className="relative z-20 w-full max-w-4xl">
        ...
        <div className="text-center mb-6 md:mb-12 animate-fade-in px-2">
          <div className="flex items-center justify-center gap-2 md:gap-4 mb-4 md:mb-6">
            ...
            <span className="text-amber-400 text-xl md:text-3xl">⚔️</span>
            <div className="h-1 w-8 md:w-20 bg-gradient-to-r from-transparent via-amber-400 to-transparent"></div>
          </div>
                  ...
                  <div className="grid gap-4 md:gap-6">
                    ...
                    <div>
                      ...
                      >
                        <span className="text-amber-600 text-base">🔢</span>
                        Matric Number 
                        <span className="text-gray-600 font-normal normal-case text-xs">(Optional)</span>
                      </label>
                      <input
                        type="text"
                        id="matricNumber"
        ...
        <div className="mt-8 md:mt-12 text-center px-2">
          <p className="text-gray-400 text-xs md:text-sm font-medium">
            ⚔️ May the best house win the Iron Throne! ⚔️
          </p>
        </div>
      </div>
    </main>
